  ...
  <main class="flex-1 overflow-hidden p-6">
    ...
    <form id="filtros" class="flex flex-wrap gap-3 items-end mt-4" onsubmit="return false">
      ...
      <div class="w-full sm:w-auto">
        ...
        <input autocomplete="off" name="email" placeholder="Buscar por email..." class="w-full sm:w-48 px-3 py-1.5 rounded-lg border border-gray-800 bg-(--input-bg-color) text-sm outline-none focus:border-(--main-color) focus:ring-(--main-color) transition-colors" data-filter="email">
      </div>
      <div class="w-full sm:w-auto">
